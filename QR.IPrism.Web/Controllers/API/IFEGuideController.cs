...
namespace QR.IPrism.API.Controllers.Module
{
    ...
    public class IFEGuideController : ApiBaseController
    {
         private readonly IDashboardAdapter _iDashboardAdapter;
         public IFEGuideController(IDashboardAdapter iDashboardAdapter)
        {
        ...
        {
            return Request.CreateResponse(HttpStatusCode.OK, _iDashboardAdapter.GetIFEGuidesAsyc().Result);
        }
    }
}
