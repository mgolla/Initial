...
namespace QR.IPrism.API.Controllers.Module
{
    ...
    public class LinkController : ApiBaseController
    {
        private readonly IDashboardAdapter _iDashboardAdapter;
        public LinkController(IDashboardAdapter iDashboardAdapter)
        {
        ...
        {
           return Request.CreateResponse(HttpStatusCode.OK, _iDashboardAdapter.GetLinksAsyc().Result);
        }
    }
}
