...
namespace QR.IPrism.EntityObjects.Module
{
    public class EVRCrewViewEO
    {
        ...
        public IList<VRCrewDetailEO> VRCrewDetail
        {
            get;
            set;
        }

        public IList<VRCrewDetailEO> VRAllCrewDetail
        {
            get;
            set;
        }

        public IList<VRPassengerDetailEO> VRPassengerDetail
        {
            get;
            set;
        }
        public IList<VRDocumentDetailEO> VRDocumentDetail
        {
            get;
            set;
        }
        public IList<VRDeptDetailEO> VRDeptDetail
        {
            get;
            set;
        }
        public IList<VRActionResolutionEO> vrAtDeptList
        {
            get;
            set;
        }
