...
{
    public class OracleODBCCommandParameter
    {
             /// <summary>
        ...
        public OracleODBCCommandParameter(string pname, object pvalue, ParameterDirection pdirection)
        {
        ...
        public OracleODBCCommandParameter(string pname, object pvalue, ParameterDirection pdirection, OracleDbType ptype)
        {
            this.ParameterDirection = pdirection;
            this.ParameterName = pname;
            this.ParameterValue = pvalue;
        ...
        /// <param name="pdirection"> input or output parameter</param>
        /// <param name="ptype">datatype of the parameter</param>
        public OracleODBCCommandParameter(string pname, ParameterDirection pdirection, OracleDbType ptype)
        {
            this.ParameterDirection = pdirection;
            this.ParameterName = pname;
            this.ParameterType = ptype;
        ...
        public OracleODBCCommandParameter(string pname, ParameterDirection pdirection, OracleDbType ptype, int plength)
        {
            this.ParameterDirection = pdirection;
            this.ParameterName = pname;
            this.ParameterType = ptype;
        ...
        /// <param name="ptype">datatype of the parameter</param>
        /// <param name="plength">length of the parameter</param>
        public OracleODBCCommandParameter(string pname, object pvalue, ParameterDirection pdirection, OracleDbType ptype, int plength)
        {
            this.ParameterDirection = pdirection;
            this.ParameterName = pname;
            this.ParameterValue = pvalue;
        ...
        /// Initializes a new instance of the <see cref="OracleCommandParameter"/> class.
        /// </summary>
        public OracleODBCCommandParameter()
        {
        }
    }
}
